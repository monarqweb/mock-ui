...
/**
 * Footer - Renders a footer section with navigation links, newsletter signup, and animated logo.
 *
 * This component displays a comprehensive footer with navigation links, social media links,
 * newsletter subscription form, contact information, and an animated SVG logo. The layout
 * is responsive and includes dark mode support.
 *
...
export function Footer({ className }: FooterProps) {
  return (
    <section
      className={cn("dark bg-background text-foreground py-32", className)}
    >
            ...
            <ul className="space-y-1">
              {NAVIGATION.map((item) => (
                <li key={item.label}>
                  <a
                    href={item.href}
                    className="text-foreground hover:text-foreground/30 tracking-tight"
                  >
                    {item.label}
                  </a>
                </li>
            ...
            <ul className="space-y-1">
              {SOCIAL_LINKS.map((item) => (
                <li key={item.label}>
                  <a
                    href={item.href}
                    className="group text-foreground hover:text-foreground/30 flex items-center gap-1 tracking-tight"
                  >
                    {item.label}{" "}
                    <ArrowUpRight className="text-foreground group-hover:text-muted-foreground/50 size-3.5" />
                  </a>
                </li>
              ))}
            </ul>
